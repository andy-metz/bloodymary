          ...
          <div class="card blue-grey darken-1">
            <div class="card-content white-text">
              ...
              <ul style="list-style-type:disc">
	              ...
	              <li> En cliquant sur l'un des noms de coktail, vous verrez apparaitre les ingrédients qui le composent, éventuellement une photo et comment le préparer</li>
                <li> Si une photo existe, en cliquant dessus vous la verrez s'agrandir</li>
                <li> Dans la description du coktail vous verrez apparaitre un bouton pour ajouter ce coktail à vos favoris</li>
				        <li> Vous pouvez bien sûr parcourir la liste de vos coktails préférés en cliquant sur le bouton "MES COKTAILS FAVORIS"</li>

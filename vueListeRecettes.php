				...
				echo '<li>';
					...
					foreach($rec as $ligne){			
						echo '<div class="collapsible-body">';
							echo '<a class="btn-floating btn-large waves-effect waves-light red right favori" data-recette="'. $recette['librecette'].'"><i class="material-icons">shopping_cart</i></a>';

<div>
	<?= '<h5 class="center">Coktails contenant '.$_SESSION['aliment'].'</h5>' ?>
</div>
<div>
				...
				echo '<li>';
					...
					foreach($rec as $ligne){			
						echo '<div class="collapsible-body">';
							echo '<a class="btn-floating pulse btn-large waves-effect waves-light red right favori" data-recette="'. $recette['librecette'].'"><i class="material-icons">shopping_cart</i></a>';
						        ...
						        echo '<div class="col s12 m6">';
						          echo '<div class="card blue-grey darken-1">';
						            echo '<div class="card-content white-text">';
						              echo '<span class="">Ingrédients:<br></span>';
